...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Daftar Kegiatan</h1>
    
    <p class="mb-4"></p>
    <div class="card shadow">
        <div class="container mt-4">
            <form action="{{route('add_kegiatan_proses')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 row ml-3 mr-3">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Judul Kegiatan</label>
                    <div class="col-sm-10">
                      <input type="text"  class="form-control" id="staticEmail" name="nama_kegiatan" required>
                      <input type="text" value="Administrator" readonly  name="nama_admin" hidden>
                    </div>
                  </div>
                <div class="mb-3 row ml-3 mr-3">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Lokasi Kegiatan</label>
                    <div class="col-sm-10">
                      <input type="text"  class="form-control" id="staticEmail" name="lokasi_kegiatan" required>
                    </div>
                  </div>
                  <div class="mb-3 row ml-3 mr-3">
                  ...
                  <div class="mb-3 row ml-3 mr-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date"  class="form-control" id="staticEmail" name="tanggal_upload" required>
                    </div>
                  </div>
                  <div class="mb-3 row ml-3 mr-3">
                    <label for="" class="col-sm-2 col-form-label">Gambar Sampul Kegiatan</label>
                    <div class="col-sm-10">
