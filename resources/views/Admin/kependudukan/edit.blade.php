...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Edit Data Kewilayahan</h1>
        ...
        <div class="container mt-4">
          <form action="{{route('penduduk.update',$penduduk->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="staticEmail" name="luas_wilayah" required value="{{$penduduk->luas_wilayah}}">
                </div>
              </div>
            <div class="mb-3 row ml-3 mr-3">
                <label for="staticEmail" class="col-sm-2 col-form-label">Jumlah Penduduk</label>
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="staticEmail" name="jumah_penduduk" required value="{{$penduduk->jumah_penduduk}}">
                </div>
            </div>
            <div class="mb-3 row ml-3 mr-3">
                <label for="staticEmail" class="col-sm-2 col-form-label">Deskripsi</label>
                <div class="col-sm-10">
                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi" rows="5" placeholder="Masukkan Deskripsi">{{ old('deskripsi') }}{{$penduduk->deskripsi}}</textarea>
                </div>
            </div>
              <div class="mb-3 row ml-3 mr-3">
                    ...
                    <div class="mt-3"> 
                        <div class="row">Gambar Sebelumnya</div>
                            <div class="row" id="imagePreviews">
                                 <img src="{{ asset('/storage/penduduk/'.$penduduk->gambar) }}" class="img-fluid rounded" alt="" width="300px" >
                            </div> 
                    </div> 
                </div>
                <div class="container mt-4">
