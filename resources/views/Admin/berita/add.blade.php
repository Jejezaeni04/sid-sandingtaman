...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Daftar Berita</h1>
    
    <p class="mb-4"></p>
    <div class="card shadow">
        <div class="container mt-4">
            <form action="{{route('add_berita_proses')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 row ml-3 mr-3">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Judul Berita</label>
                    <div class="col-sm-10">
                      <input type="text"  class="form-control" id="staticEmail" name="nama_berita" required>
