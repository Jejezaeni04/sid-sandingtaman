        ...
        <div class="container mt-4">
          <form action="{{route('aparatur.update',$aparatur->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <input type="text"  class="form-control" id="staticEmail" name="nama" required value="{{$aparatur->nama}}">
                </div>
              </div>
            <div class="mb-3 row ml-3 mr-3">
                <label for="staticEmail" class="col-sm-2 col-form-label">NIK</label>
                <div class="col-sm-10">
                  <input type="number"  class="form-control" id="staticEmail" name="nik" required value="{{$aparatur->nik}}">
                </div>
              </div>
            <div class="mb-3 row ml-3 mr-3">
                <label for="staticEmail" class="col-sm-2 col-form-label">No. Hp</label>
                <div class="col-sm-10">
                  <input type="number"  class="form-control" id="staticEmail" name="nohp" required value="{{$aparatur->nohp}}">
                </div>
            </div>
            <div class="mb-3 row ml-3 mr-3">
                <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                <div class="col-sm-10">
                  <input type="email"  class="form-control" id="staticEmail" name="email" required value="{{$aparatur->email}}">
                </div>
            </div>
            <div class="mb-3 row ml-3 mr-3">
            ...
            <div class="mb-3 row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="inputGroupSelect01" name="jabatan" required>
                        <option selected >{{$aparatur->jabatan}}</option>
              ...
              <div class="mb-3 row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                    <input type="date"  class="form-control" id="staticEmail" name="tgl_lahir" required value="{{$aparatur->tgl_lahir}}">
                </div>
              </div>
              <div class="mb-3 row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="row" id="imagePreviews">
                            <img src="{{ asset('/storage/aparatur/'.$aparatur->foto) }}" class="img-fluid rounded" alt="" width="300px" >
                        </div> 
                    </div> 
                </div>
                <div class="container mt-4">
