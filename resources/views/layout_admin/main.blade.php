...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/avatar_css.css')}}">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard')}}">
                ...
                <div class=" mx-3">Sandingtaman</div>
            </a>
            ...
            <li class="nav-item {{ (Route::is('berita','kegiatan')) ? 'active' : ''}}">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Berita dan Kegiatan :</h6>
                        <a class="collapse-item {{ (Route::is('berita')) ? 'active' : ''}}" href="/berita">Berita</a>
                        <a class="collapse-item {{ (Route::is('kegiatan')) ? 'active' : ''}}" href="/kegiatan">Kegiatan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item {{ (Route::is('galeri.index')) ? 'active' : ''}}">
